...
package body Display is
   ...
   use type Layout.Turnout_Direction;
      ...
      record
         ...
         case Which is
            ...
            when Turnout_Change =>
               ...
               Turn_Direction : Layout.Turnout_Direction;
               Moving         : Boolean;
            when Error =>
   ...
   -----------------------------------------------------------------------------
   function To_String (Item : in Engineers.Skill_Level) return String is
   -- Convert a skill level to a string with 1st character capitalized
      Result : String := Engineers.Skill_Level'Image (Item);
   begin
   ...
   ----------------------------------------------------------------------------
   procedure Put (Train : in Trains.Train_ID;
                  Skill : in Engineers.Skill_Level) is
   ...
   Change_Call    : Turnouts.Change_Ptr;
begin
   Change_Call    := Change_Callback'Access;
   Turnouts.Set_Change_Callback (Change_Call);
end Display;
